...
template<class T, class Allocator = std::allocator<T>, class I> // Arbitrary allocator can be used
inline IntegerOnly<I, std::vector<T, Allocator>> reserve_vector(I capacity)
{
